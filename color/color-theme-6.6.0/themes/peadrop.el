;;; -*- Mode: Emacs-Lisp -*-
;;; http://svn.peadrop.com/emacs/lisp/theme.el
;;;

(require 'color-theme)

(defun color-theme-peadrop-dark ()
  (interactive)
...
(defun color-theme-peadrop-light ()
  (interactive)
...
(defun color-theme-peadrop-dull ()
  (interactive)
  (setq global-hl-line-mode nil)
  ;; main theme
  (color-theme-install
...
;; (frame-setup
;;  '(("flyer"   47 100) ;; my laptop
;;    ("helios"  55 130) ;; my desktop
;;    ))